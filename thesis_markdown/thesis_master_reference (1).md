...
**Source of truth:** thesis_verified_results.json (54 KB, recomputed from 100,080 raw predictions, 15 models verified 2026-04-13)
...
All CIs verified from 15-model recomputation (10,000 resamples each).
...
Source: recompute_all_metrics.py (15-model run, 2026-04-13). All 13 pairwise tests verified.
...
Source: recompute_all_metrics.py (15-model run, 2026-04-13). All 9 paired tests verified.
...
| Best NER vs M4b (multi-epoch) | +0.022 | [+0.012, +0.031] | YES |
| Best NER vs Final NER (regularisation) | +0.007 | [+0.003, +0.011] | YES |
| Final NER vs V4 (combined strategy) | +0.047 | [+0.040, +0.053] | YES |
| Final ByT5 vs Gemma4 E4B | +0.071 | [+0.063, +0.079] | YES |

### 4.5 Cross-Model Agreement Analysis

Source: recompute_all_metrics.py (15-model run, 2026-04-13).

| Pair | Agreement | Both OK | Both Err | A Only | B Only | Error Overlap |
|------|-----------|---------|----------|--------|--------|--------------|
| M4b vs V4 | 75.5% | 4,106 | 930 | 972 | 664 | 36.2% |
| V4 vs Gemma4 E4B | 82.1% | 4,048 | 1,429 | 722 | 473 | 54.5% |
| Gemma4 E4B vs Gemma4 31B | 76.8% | 3,451 | 1,673 | 1,070 | 478 | 51.9% |
| Best NER vs Final NER | 93.9% | 5,011 | 1,252 | 242 | 167 | 75.4% |
| Best NER vs M4b | 78.9% | 4,460 | 801 | 793 | 618 | 36.2% |

Key observations:
- Best NER and Final NER agree on 93.9% of sentences with 75.4% error overlap, confirming they are closely related models that differ primarily on cross-domain capability.
- Best NER and M4b agree on only 78.9% with 36.2% error overlap, meaning multi-epoch training changed which sentences the model gets right, not just how many.
- V4 and Gemma4 E4B have 54.5% error overlap — nearly half their errors are different, suggesting ensemble potential.
...
| **Total** | | **~170,851** (13 test-contaminated removed = 170,838 actual) | **100%** |
...
This document contains every verified number, every known limitation, and every critical assessment of the experimental findings. All values verified from the 15-model recomputation (recompute_all_metrics.py, completed 2026-04-13). The thesis_verified_results.json (54 KB) contains the machine-readable version of all metrics, statistical tests, and cross-model analyses.
